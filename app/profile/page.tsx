  ...
  useEffect(() => {
    ...
    const attemptRefresh = async () => {
      if (refreshAttempts < MAX_REFRESH_ATTEMPTS) {
        refreshAttempts++;
        console.log(
          `Attempting auto-refresh (${refreshAttempts}/${MAX_REFRESH_ATTEMPTS})`
        );
              ...
              {isInTrial ? (
                <>
                  <p className="text-yellow-600 dark:text-yellow-400">
                    You are currently in your 48-hour trial period. Your trial
                    will end on{" "}
                    {trialEndTime
                  ...
                  <p>
                    Subscribe now to continue using the app after the trial
                    ends.
                  </p>
                </>
              ) : trialEndTime ? (
