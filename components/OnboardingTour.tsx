    ...
    () => [
      {
        ...
        description: (
          <div className="flex flex-col gap-2">
            <p>
              Click{" "}
              <button className="px-2 py-1 text-xs rounded bg-primary hover:bg-primary-darker text-white w-fit">
                Use Template
              </button>{" "}
              to import one of our pre-made recipes into your collection.
            </p>
          </div>
        ),
      ...
      },
      {
        ...
        description: (
          <div className="flex flex-col gap-2 items-center">
            ...
            <button className="w-12 h-12 mt-2 rounded-full flex items-center justify-center bg-primary hover:bg-primary-darker shadow-lg">
      ...
      },
      {
        ...
        description: (
          <div className="flex flex-col gap-2 items-center">
            ...
            <button className="w-12 h-12 mt-2 rounded-full flex items-center justify-center bg-red-500 hover:bg-red-600 shadow-lg">
              <span className="text-xl text-white">⏹</span>
            </button>
          </div>
        ),
